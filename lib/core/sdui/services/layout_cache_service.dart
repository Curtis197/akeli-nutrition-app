...
const String layoutsBoxName = 'layout_cache';
const String modesBoxName = 'mode_state';

/// Service responsible for caching and retrieving SDUI layouts using Hive.
///
/// Boxes are opened by main.dart at startup; this service accesses them lazily.
class LayoutCacheService {
  ...
  Box<dynamic> get _layoutsBox => Hive.box(layoutsBoxName);
  Box<dynamic> get _modesBox => Hive.box(modesBoxName);
  ...
  Map<String, dynamic>? getLayout(String mode) {
    ...
    return _deepConvert(cachedData) as Map<String, dynamic>;
  }
