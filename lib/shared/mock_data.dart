...
class MockData {
  ...
  static final List<Recipe> recipes = [
    Recipe(
      ...
      isPublished: true,
      ingredients: const [
        RecipeIngredient(id: '', ingredientId: 'i1', name: 'Riz brisé', quantity: 1, unit: 'kg', isOptional: false),
        RecipeIngredient(id: '', ingredientId: 'i2', name: 'Mérou (Thiof)', quantity: 1.5, unit: 'kg', isOptional: false),
        RecipeIngredient(id: '', ingredientId: 'i3', name: 'Concentré de tomate', quantity: 200, unit: 'g', isOptional: false),
      ],
      steps: const [
        RecipeStep(id: '', stepNumber: 1, instruction: 'Préparer la farce (rof) avec du persil, piment, sel et ail.'),
        RecipeStep(id: '', stepNumber: 2, instruction: 'Faire dorer le poisson et réserver.'),
      ],
    ...
    Recipe(
      ...
      isPublished: true,
      ingredients: const [
        RecipeIngredient(id: '', ingredientId: 'i4', name: 'Feuilles de Ndolé', quantity: 500, unit: 'g', isOptional: false),
        RecipeIngredient(id: '', ingredientId: 'i5', name: 'Arachides blanches', quantity: 300, unit: 'g', isOptional: false),
        RecipeIngredient(id: '', ingredientId: 'i6', name: 'Crevettes', quantity: 250, unit: 'g', isOptional: false),
      ],
      steps: const [
        RecipeStep(id: '', stepNumber: 1, instruction: 'Laver et hacher les feuilles de ndolé.'),
        RecipeStep(id: '', stepNumber: 2, instruction: 'Écraser les arachides et cuire la pâte.'),
      ],
