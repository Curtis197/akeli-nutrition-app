...
class Recipe {
  ...
  const Recipe({
    ...
    this.skinTarget,
    this.formulation,
    this.isPremadeProduct = false,
    this.productType = 'diy',
    this.virtueWeights,
  ...
  factory Recipe.fromJson(Map<String, dynamic> json) {
    ...
    return Recipe(
        ...
        isPremadeProduct: (json['is_premade_product'] as bool?) ?? false,
        productType: (json['product_type'] as String?) ?? 'diy',
