...
class _MealDetailWidgetState extends State<MealDetailWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'MealDetail'});
              ...
              headerSliverBuilder: (context, _) => [
                SliverAppBar(
                  ...
                  leading: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent(
                          'MEAL_DETAIL_arrow_back_rounded_ICN_ON_TA');
                                      ...
                                      child: CarouselSlider.builder(
                                        ...
                                        itemBuilder:
                                          ...
                                          return InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'MEAL_DETAIL_PAGE_Image_n6t1fezj_ON_TAP');
                                              logFirebaseEvent(
                                                  'Image_expand_image');
                                              ...
                                              children: [
                                                if (rowMealRow?.consumed ==
                                                  ...
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'MEAL_DETAIL_PAGE_Icon_xby6bwhv_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Icon_backend_call');
                                                ...
                                                if (rowMealRow?.consumed ==
                                                  ...
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'MEAL_DETAIL_PAGE_Icon_et1shoip_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Icon_backend_call');
                                                      await MealTable().update(
                                                        data: {
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'MEAL_DETAIL_PAGE_CHOISIR_BTN_ON_TAP');
                                      logFirebaseEvent(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'MEAL_DETAIL_PAGE_PERSONALISER_BTN_ON_TAP');
