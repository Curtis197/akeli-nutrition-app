...
class _NotificationDemandWidgetState extends State<NotificationDemandWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('NOTIFICATION_DEMAND_notification_demand_');
      logFirebaseEvent('notification_demand_backend_call');
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () async {
        logFirebaseEvent('NOTIFICATION_DEMAND_Container_ginss95w_O');
