...
class _ReceipeDetailWidgetState extends State<ReceipeDetailWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'receipe_detail'});
              ...
              headerSliverBuilder: (context, _) => [
                SliverAppBar(
                  ...
                  leading: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent(
                          'RECEIPE_DETAIL_arrow_back_rounded_ICN_ON');
                                            ...
                                            child: CarouselSlider.builder(
                                              ...
                                              itemBuilder:
                                                ...
                                                return InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'RECEIPE_DETAIL_Image_ggkurxaq_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Image_expand_image');
                                    ...
                                    if (FFAppState().mealPlan != null)
                                      Align(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'RECEIPE_DETAIL_AJOUTER_AU_CALENDRIER_BTN');
                                            logFirebaseEvent(
                                                'Button_bottom_sheet');
                                      ...
                                      children: [
                                        ...
                                        Align(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'RECEIPE_DETAIL_PAGE_Text_omw5wmmu_ON_TAP');
                                              logFirebaseEvent(
                                                  'Text_bottom_sheet');
                                              await showModalBottomSheet(
                                                isScrollControlled: true,
                                      ...
                                      children: [
                                        ...
                                        Align(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'RECEIPE_DETAIL_PAGE_Text_8tr2dyu3_ON_TAP');
                                              logFirebaseEvent(
                                                  'Text_bottom_sheet');
                                              await showModalBottomSheet(
                                                isScrollControlled: true,
                                        ...
                                        builder: (context) =>
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            return FFButtonWidget(
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'RECEIPE_DETAIL_PAGE_COMMENTER_BTN_ON_TAP');
                                                logFirebaseEvent(
                                                    'Button_bottom_sheet');
                                                await showModalBottomSheet(
                                                  isScrollControlled: true,
