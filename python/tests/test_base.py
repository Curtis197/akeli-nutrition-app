...
def test_keyword_match_true_across_accent_mismatch():
    # Regression: "Attiéké" (accented) must match "Attieke" (unaccented) —
    # the same word, different spelling. Found via a real live site whose
    # search returns "Attieke" for a French-accented ingredient query.
    assert keyword_match('Attiéké', 'Attieke', set()) is True
