...
**→ [`V1_ARCHITECTURE_DECISIONS.md`](..\03_v1_app_flutter\architecture_principes\V1_ARCHITECTURE_DECISIONS.md)** — décisions d'architecture (ADR). **Lire en premier en cas de contradiction entre deux docs.**

### Accès rapide par domaine

| Besoin | Document |
|--------|----------|
| Vue d'ensemble du système | [`V1_ARCHITECTURE_GLOBALE.md`](..\03_v1_app_flutter\architecture_principes\V1_ARCHITECTURE_GLOBALE.md) |
| Backend — Edge Functions & SQL | [`V1_BACKEND_EDGE_FUNCTIONS.md`](..\03_v1_app_flutter\backend_database\V1_BACKEND_EDGE_FUNCTIONS.md) |
| Schéma base de données | [`V1_DATABASE_SCHEMA.md`](..\03_v1_app_flutter\backend_database\V1_DATABASE_SCHEMA.md) |
| Pages UI — navigation globale | [`INDEX.md`](..\03_v1_app_flutter\pages_specifications\INDEX.md) |
| Mode Fan — logique métier | [`AKELI_MODE_FAN.md`](..\05_business_marche\AKELI_MODE_FAN.md) |
| Modèle économique créateur | [`AKELI_MODELE_CREATEUR.md`](..\05_business_marche\AKELI_MODELE_CREATEUR.md) |
| Assistant IA | [`V1_AI_ASSISTANT_ARCHITECTURE.md`](..\03_v1_app_flutter\ai_assistant\V1_AI_ASSISTANT_ARCHITECTURE.md) |
