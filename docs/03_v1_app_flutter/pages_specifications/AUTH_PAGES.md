...
┌─────────────────────────────────┐
│                                 │
│         Akeli             │  ← Large brand title, primary color
│   Bienvenue sur Akeli      │  ← subtitle
│                                 │
│  ╔═════════════════════════╗   │
...
**Header (230px):** "Akeli" brand title in primary color, subtitle "Bienvenue sur Akeli"
...
**Tab 1 — Sign Up:**
- Title "Se créer un compte", subtitle "Commencez avec Akeli…"
...
- The HTML content references "Akeli" — update to "Akeli" or confirm brand name
