...
> **Purpose:** Complete page-by-page specifications for rebuilding Akeli V1 in Flutter (without FlutterFlow). Each document covers UI layout, data sources, interactions, navigation, state, and V1 changes.
...
2. Cross-reference [ARCHITECTURE_REDESIGN.md](..\architecture_principes\ARCHITECTURE_REDESIGN.md) for state management patterns
3. Cross-reference [DESIGN_SYSTEM.md](..\architecture_principes\DESIGN_SYSTEM.md) for styling
4. Use Supabase Auth (not Firebase) for all auth checks — see [ARCHITECTURE_REDESIGN.md](..\architecture_principes\ARCHITECTURE_REDESIGN.md)
