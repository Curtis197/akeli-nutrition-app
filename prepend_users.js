...
VALUES
('1a1b225a-1328-4d58-976f-253574410c6f', '1a1b225a-1328-4d58-976f-253574410c6f', format('{"sub":"%s","email":"%s"}', '1a1b225a-1328-4d58-976f-253574410c6f', 'user1@example.com')::jsonb, 'email', now(), now(), now()),
('f1414791-8f57-4bf4-a730-42f3c89dad95', 'f1414791-8f57-4bf4-a730-42f3c89dad95', format('{"sub":"%s","email":"%s"}', 'f1414791-8f57-4bf4-a730-42f3c89dad95', 'test@client.com')::jsonb, 'email', now(), now(), now())
...
if (!content.includes('test@client.com')) {
    fs.writeFileSync('supabase/seed.sql', usersSql + content, 'utf8');
    console.log('Prepended users to seed.sql');
} else {
    console.log('Users already in seed.sql');
}
