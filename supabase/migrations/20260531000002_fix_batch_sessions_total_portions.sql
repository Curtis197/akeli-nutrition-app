-- =============================================================================
-- Migration: 20260531000002_fix_batch_sessions_total_portions.sql
-- Description: Fix create_batch_sessions — total_portions was CEIL(SUM(servings))
--              which rounds to 1 when entries have fractional servings (e.g. 0.4).
--              Use appearance_count (COUNT(*)) instead: one portion per meal entry.
--              scale_factor continues to use SUM(servings) for ingredient scaling.
-- =============================================================================
