-- supabase/migrations/20260629000005_user_profile_meal_schedule_random.sql
-- Description: Add meal_schedule_random preference to user_profile and generators.

ALTER TABLE public.user_profile
  ADD COLUMN IF NOT EXISTS meal_schedule_random BOOLEAN NOT NULL DEFAULT FALSE;

COMMENT ON COLUMN public.user_profile.meal_schedule_random IS
  'Whether to randomly shuffle generated meals of each type across the week.';
...
BEGIN
  ...
  SELECT COALESCE(meal_variety_days, 7), COALESCE(meal_schedule_random, false)
  INTO v_variety_days, v_random_order
