-- =============================================================================
-- AKELI — Feed RPC: switch calorie filter from total calories to calories/100g
-- Migration: 20260614000001_feed_rpc_calorie_per_100g_filter.sql
--
-- p_min_cal / p_max_cal now bound rm.calories_per_100g instead of rm.calories,
-- aligning the filter with what the recipe card displays.
-- =============================================================================

DROP FUNCTION IF EXISTS generate_feed_personalized(uuid, int, uuid[], text, text, int, numeric, numeric, text, text);
