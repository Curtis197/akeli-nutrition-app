-- =============================================================================
-- Migration: 20260603000002_fix_generate_meal_plan_max_repeat.sql
-- Description: Add p_max_recipe_repeat parameter to generate_meal_plan so the
--              batch_cooking_max_portions user preference controls how many
--              times any single recipe may appear in the generated plan.
--              Previously hardcoded to 3; now passed from the edge function.
--              Drops the stale 4-arg overload; DEFAULT 3 on the new param
--              keeps all existing callers (cron, etc.) working unchanged.
-- =============================================================================

DROP FUNCTION IF EXISTS generate_meal_plan(uuid, integer, integer, date);
