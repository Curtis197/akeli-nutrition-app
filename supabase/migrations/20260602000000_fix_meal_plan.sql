-- supabase/migrations/20260602000000_fix_meal_plan.sql
-- Fixes regression where generate_meal_plan overwrote v2 (components schema) with v1
-- Re-applies allergen filtering to the correct latest v2 schema.
