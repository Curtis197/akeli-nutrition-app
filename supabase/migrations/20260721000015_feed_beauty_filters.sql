-- Migration: 20260721000015_feed_beauty_filters.sql
-- Description: Extend generate_feed_personalized RPC with p_product_type, p_routine_category, and p_beauty_goal filters
...
DROP FUNCTION IF EXISTS public.generate_feed_personalized(uuid, integer, uuid[], text, text, integer, numeric, numeric, text, text, text, text, text, text);
