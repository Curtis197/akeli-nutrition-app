-- =============================================================================
-- Migration: 20260525000002_scale_generated_meal_plan.sql
-- Description: Update generate_meal_plan to scale ingredients based on user_goal
-- =============================================================================
...
BEGIN
  ...
  FOR v_day IN 0..(p_days - 1) LOOP
    ...
    FOREACH v_meal_type IN ARRAY v_meal_types LOOP
      ...
      -- Calculate scaled servings based on calorie goal
      v_servings := 1.0;
      ...
      -- Create entry with calculated servings
