...
-- Description: Rewrite generate_meal_plan to read slot structure from meal_distribution
-- instead of hardcoded v_meal_types. Slot nickname and sort_order are now written
-- to meal_plan_entry. Falls back to 3-meal structure when no distribution exists.
