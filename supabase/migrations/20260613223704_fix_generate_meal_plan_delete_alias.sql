-- Fix: "column reference meal_plan_id is ambiguous" at execution time.
-- meal_plan_id exists both as a RETURNS TABLE output column and as a column
-- in meal_plan_entry. Use a table alias on the DELETE to force table-column
-- resolution instead of the PL/pgSQL output variable.
