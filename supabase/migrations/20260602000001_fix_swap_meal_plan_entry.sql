-- =============================================================================
-- Migration: 20260602000001_fix_swap_meal_plan_entry.sql
-- Description: Fix swap_meal_plan_entry — two bugs found during test walkthrough:
--   1. Computed macro columns (calories_computed, protein_g_computed, etc.) were
--      not updated after a swap, leaving stale values from the old recipe.
--   2. meal_ingredient rows were not replaced, so the per-entry ingredient list
--      displayed in the app still showed the old recipe's ingredients.
-- =============================================================================
