-- supabase/migrations/20260609000001_sync_generate_meal_plan_cleanup.sql
--
-- Description: Syncs generate_meal_plan with generate_meal_plan_internal
-- to properly delete old cooking sessions and shopping lists when regenerating,
-- and generates new batch cooking sets and shopping lists at the end.
